...
(function() {
    ...
    var linkDialogText = gettext('Insert Hyperlink'),
        linkUrlHelpText = gettext("e.g. 'https://google.com'"),
        ...
        linkDefaultText = 'https://'; // The default text that appears in input
    ...
    var imageDialogText = gettext('Insert Image (upload file or type URL)'),
        imageUrlHelpText = gettext("Type in a URL or use the \"Choose File\" button to upload a file from your machine. (e.g. 'https://example.com/img/clouds.jpg')"),  // eslint-disable-line max-len
        imageDescriptionLabel = gettext('Image Description'),
        imageDefaultText = 'https://', // The default text that appears in input
        ...
        imageDescriptionHelpLink = {
            href: 'https://www.w3.org/TR/html5/embedded-content-0.html#alt',
